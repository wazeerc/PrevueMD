...
<template>
  <header class="header-footer border-b-2">
    <h1 :class="cn('font-sans font-bold text-neutral-200 dark:text-neutral-200', 'text-lg', 'sm:text-xl', 'md:text-2xl',
    ...
    <h2 :class="cn('text-neutral-400 dark:text-neutral-400', 'pl-2', 'mt-4', 'font-medium', 'text-sm', 'sm:text-base',
      'motion-preset-blur-up-md motion-delay-500', 'hidden lg:block')">
      A real-time
      <a :class="cn(
        'underline cursor-help',
        'hover:text-neutral-500 dark:hover:text-neutral-500 transition-colors ease duration-200'
      )"
